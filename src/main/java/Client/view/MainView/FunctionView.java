...
public class FunctionView {
    ...
    public void functionView(){
        ...
        new FunctionController(client,buffer).functionChoose(Integer.parseInt(scanner.nextLine()));
    }

    public void updateView(){
        System.out.println("==========================================");
        System.out.println("1,修改用户数据 2,修改收货地址 3,增加新地址 4,返回");
        new FunctionController(client,buffer).updateChoose(Integer.parseInt(scanner.nextLine()));
    }
